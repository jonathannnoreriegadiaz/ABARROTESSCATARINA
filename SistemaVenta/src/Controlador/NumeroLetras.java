...
if(decimalentero==0){
 resultado=DineroLetras(millares,centenas, decenas, unidades)+" con  "+reducir.format(decimalentero)+"0/100 Pesos ";
}else{ resultado=(DineroLetras(millares,centenas, decenas, unidades)+" con  "+reducir.format(decimalentero)+"/100 Pesos ");
 }return resultado;}
}
